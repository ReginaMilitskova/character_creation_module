...
# Вводим глобальные стандартные константы
DEFAULT_ATTACK = 5
DEFAULT_DEFENCE = 10
DEFAULT_STAMINA = 80
...
class Character:
    ...
    def attack(self):
        # Вместо диапазона записана переменная класса(константа).
    ...
    def __str__(self):
        # Атрибут для вывода имени объекта класса __class__.__name__
        return f'{self.__class__.__name__} - {self.BRIEF_DESC_CHAR_CLASS}.'

# Создаем классы-наследники и переопределяем в них свойства класса-родителя
